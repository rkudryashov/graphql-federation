...
import io.graphqlfederation.authservice.web.dto.GraphQLRequest
import io.graphqlfederation.authservice.web.dto.GraphQLResponse
...
class GraphQLClient(
    ...
    fun <T> sendRequest(query: String, responseType: TypeReference<T>): T {
        ...
        val requestBodyAsString = objectMapper.writeValueAsString(
            GraphQLRequest(
                null,
                query
            )
